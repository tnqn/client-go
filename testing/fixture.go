...
func filterByNamespaceAndName(objs map[types.NamespacedName]runtime.Object, ns, name string) ([]runtime.Object, error) {
	var res []runtime.Object

	if len(name) > 0 {
		obj, ok := objs[types.NamespacedName{Namespace: ns, Name: name}]
		if ok {
			res = append(res, obj)
		}
		return res, nil
